...
var Icon$e = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 25 24" }, props),
        React__default['default'].createElement("path", { d: "M19.2 3H5.19995C4.09995 3 3.19995 3.9 3.19995 5V19C3.19995 20.1 4.09995 21 5.19995 21H19.2C20.3 21 21.2 20.1 21.2 19V5C21.2 3.9 20.3 3 19.2 3ZM19.2 19H5.19995V5H19.2V19Z", fill: "#3B8ED4" }),
        React__default['default'].createElement("path", { d: "M11.45 7.72021H6.44995V9.22022H11.45V7.72021Z", fill: "#3B8ED4" }),
        React__default['default'].createElement("path", { d: "M18.2 15.75H13.2V17.25H18.2V15.75Z", fill: "#3B8ED4" }),
        React__default['default'].createElement("path", { d: "M18.2 13.25H13.2V14.75H18.2V13.25Z", fill: "#3B8ED4" }),
        React__default['default'].createElement("path", { d: "M8.19995 18H9.69995V16H11.7V14.5H9.69995V12.5H8.19995V14.5H6.19995V16H8.19995V18Z", fill: "#3B8ED4" }),
        React__default['default'].createElement("path", { d: "M14.29 10.95L15.7 9.54L17.11 10.95L18.17 9.89L16.76 8.47L18.17 7.06L17.11 6L15.7 7.41L14.29 6L13.23 7.06L14.64 8.47L13.23 9.89L14.29 10.95Z", fill: "#3B8ED4" })));
};
...
var Icon$q = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React__default['default'].createElement("image", { width: "32", height: "32", href: "/images/2local/Logo.svg" })));
};
...
var Icon$t = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default['default'].createElement("path", { d: "M18 19H6C5.45 19 5 18.55 5 18V6C5 5.45 5.45 5 6 5H11C11.55 5 12 4.55 12 4C12 3.45 11.55 3 11 3H5C3.89 3 3 3.9 3 5V19C3 20.1 3.9 21 5 21H19C20.1 21 21 20.1 21 19V13C21 12.45 20.55 12 20 12C19.45 12 19 12.45 19 13V18C19 18.55 18.55 19 18 19ZM14 4C14 4.55 14.45 5 15 5H17.59L8.46 14.13C8.07 14.52 8.07 15.15 8.46 15.54C8.85 15.93 9.48 15.93 9.87 15.54L19 6.41V9C19 9.55 19.45 10 20 10C20.55 10 21 9.55 21 9V4C21 3.45 20.55 3 20 3H15C14.45 3 14 3.45 14 4Z", fill: props === null || props === void 0 ? void 0 : props.fill })));
};
...
var Icon$v = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: 90, height: 90, href: "/images/2local/Spinner.svg" })));
};
...
var Icon$I = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: 90, height: 90, href: "/images/lottery/Prev.svg" })));
};

var Icon$J = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: 90, height: 90, href: "/images/lottery/Next.svg" })));
};
...
var LinkExternal = function (_a) {
    var _b = _a.fill, fill = _b === void 0 ? "#000000" : _b, children = _a.children, props = __rest(_a, ["fill", "children"]);
    return (React__default['default'].createElement(Link, __assign({ external: true }, props),
        children,
        React__default['default'].createElement(Icon$t, { color: "primary", ml: "4px", fill: fill })));
};
...
var SpinnerIcon = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React__default['default'].createElement("image", { width: "96", height: "96", href: "/images/2local/Spinner.svg" })));
};
...
var Icon$M = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 55 55" }, props),
        React__default['default'].createElement("image", { width: "55", height: "55", href: "/images/2local/MenuToggle.svg" })));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 130 32" }, props),
        React__default['default'].createElement("image", { width: "130", height: "32", href: "/images/2local/Logo.svg" })));
};
...
var Icon$18 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/Exchange.svg" })));
};

var Icon$19 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/LaunchPool.svg" })));
};

var Icon$1a = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/YieldFarming.svg" })));
};

var Icon$1b = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/Rewards.svg" })));
};

var Icon$1c = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/Airdrop.svg" })));
};

var Icon$1d = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/Lottery.svg" })));
};

var Icon$1e = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/Prediction.svg" })));
};

var Icon$1f = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/DiamondMenu.svg" })));
};

var Icon$1g = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/BNB.svg" })));
};

var Icon$1h = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/2LC.svg" })));
};

var Icon$1i = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/BUSD.svg" })));
};

var Icon$1j = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/BETH.svg" })));
};

var Icon$1k = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/ETH.svg" })));
};

var Icon$1l = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/USD.svg" })));
};

var Icon$1m = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/XLM.svg" })));
};

var Icon$1n = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/BTC.svg" })));
};

var Icon$1o = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/UNI.svg" })));
};

var Icon$1p = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/CAKE.svg" })));
};

var Icon$1q = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/BNB2LC.svg" })));
};

var Icon$1r = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/BETH2LC.svg" })));
};

var Icon$1s = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/BUSD2LC.svg" })));
};

var Icon$1t = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/2LC2LC.svg" })));
};

var Icon$1u = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/Diamond.svg" })));
};

var Icon$1v = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/hide.svg" })));
};

var Icon$1w = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/show.svg" })));
};

var Icon$1x = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "10", height: "20", href: "/images/2local/expand.svg" })));
};

var Icon$1y = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: "/images/2local/BEP20.svg" })));
};
...
var IconModule = /*#__PURE__*/Object.freeze({
    ...
    YieldFarmingIcon: Icon$1a,
    RewardsIcon: Icon$1b,
    AirdropIcon: Icon$1c,
    LotteryIcon: Icon$1d,
    PredictionIcon: Icon$1e,
    DiamondMenuIcon: Icon$1f,
    BNBIcon: Icon$1g,
    L2LIcon: Icon$1h,
    BUSDIcon: Icon$1i,
    BETHIcon: Icon$1j,
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "10px" }, isPushed ? (React__default['default'].createElement(Icon$N, { width: "55px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$M, { width: "55px", color: "textSubtle" }))),
...
var SIDEBAR_WIDTH_FULL = 460;
var SIDEBAR_WIDTH_FULL_WITHOUT_BALANCE = 260;
...
var MenuEntry = styled__default['default'].div(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  width: ", ";\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: 42px;\n  font: normal normal bold 20px/24px Swis721 BT;\n  padding: ", ";\n  font-size: ", ";\n  background: transparent linear-gradient(180deg, #53a8f0 0%, #2d7fc4 100%) 0% 0% no-repeat padding-box;\n  color: #ffffff;\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: #ffffff;\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"], ["\n  width: ", ";\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: 42px;\n  font: normal normal bold 20px/24px Swis721 BT;\n  padding: ", ";\n  font-size: ", ";\n  background: transparent linear-gradient(180deg, #53a8f0 0%, #2d7fc4 100%) 0% 0% no-repeat padding-box;\n  color: #ffffff;\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: #ffffff;\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"])), function (_a) {
    ...
    return (showBalance ? SIDEBAR_WIDTH_FULL_WITHOUT_BALANCE + "px" : "100%");
}, function (_a) {
...
var SideBarMainAndSubMenu = function (_a) {
    var label = _a.label, icon = _a.icon, isPushed = _a.isPushed, pushNav = _a.pushNav, _b = _a.initialOpenState, initialOpenState = _b === void 0 ? true : _b, children = _a.children, className = _a.className, showBalance = _a.showBalance;
    ...
    return (React__default['default'].createElement(Container$2, null,
        React__default['default'].createElement(MenuEntry, { onClick: handleClick, className: className, showBalance: showBalance },
            icon,
            React__default['default'].createElement(LinkLabel, { isPushed: isPushed }, label),
            isOpen ? React__default['default'].createElement(Icon$8, { width: "30px" }) : React__default['default'].createElement(Icon$7, { width: "30px" })),
        React__default['default'].createElement(AccordionContent, { isOpen: isOpen, isPushed: isPushed, maxHeight: 400 }, children)));
};
var templateObject_1$A, templateObject_2$b;

var rainbowAnimation$1 = styled.keyframes(templateObject_1$B || (templateObject_1$B = __makeTemplateObject(["\n  0%,\n  100% {\n    background-position: 0 0;\n  }\n  50% {\n    background-position: 100% 0;\n  }\n"], ["\n  0%,\n  100% {\n    background-position: 0 0;\n  }\n  50% {\n    background-position: 100% 0;\n  }\n"])));
var LinkLabelSub = styled__default['default'].div(templateObject_2$c || (templateObject_2$c = __makeTemplateObject(["\n  color: #4c566c;\n  transition: color 0.4s;\n  font: normal normal normal 12px/37px Swis721 BT;\n  flex-grow: 1;\n  display: flex;\n  flex-direction: row;\n"], ["\n  color: #4c566c;\n  transition: color 0.4s;\n  font: normal normal normal 12px/37px Swis721 BT;\n  flex-grow: 1;\n  display: flex;\n  flex-direction: row;\n"])));
var MenuEntrySub = styled__default['default'].div(templateObject_3$7 || (templateObject_3$7 = __makeTemplateObject(["\n  width: ", ";\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: 42px;\n  padding: 0 24px;\n  font: normal normal normal 12px/37px Swis721 BT;\n  color: #4c566c;\n  pointer-events: ", ";\n  opacity: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: #ffffff;\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"], ["\n  width: ", ";\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: 42px;\n  padding: 0 24px;\n  font: normal normal normal 12px/37px Swis721 BT;\n  color: #4c566c;\n  pointer-events: ", ";\n  opacity: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: #ffffff;\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"])), function (_a) {
    var showBalance = _a.showBalance;
    return (showBalance ? SIDEBAR_WIDTH_FULL_WITHOUT_BALANCE + "px" : "100%");
}, function (_a) {
...
var rainbowAnimation$2 = styled.keyframes(templateObject_1$C || (templateObject_1$C = __makeTemplateObject(["\n  0%,\n  100% {\n    background-position: 0 0;\n  }\n  50% {\n    background-position: 100% 0;\n  }\n"], ["\n  0%,\n  100% {\n    background-position: 0 0;\n  }\n  50% {\n    background-position: 100% 0;\n  }\n"])));
styled__default['default'].div(templateObject_2$d || (templateObject_2$d = __makeTemplateObject(["\n  color: #4c566c;\n  transition: color 0.4s;\n  font: normal normal normal 12px/37px Swis721 BT;\n  flex-grow: 1;\n"], ["\n  color: #4c566c;\n  transition: color 0.4s;\n  font: normal normal normal 12px/37px Swis721 BT;\n  flex-grow: 1;\n"])));
var MenuEntrySubSub = styled__default['default'].div(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: 42px;\n  padding-left: 40px;\n  font: normal normal normal 12px/37px Swis721 BT;\n  color: #4c566c;\n\n  background-color: ", ";\n  outline: none;\n  box-sizing: border-box;\n  border-left: ", ";\n  padding-left: -5px;\n\n  pointer-events: ", ";\n  opacity: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: #ffffff;\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"], ["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: 42px;\n  padding-left: 40px;\n  font: normal normal normal 12px/37px Swis721 BT;\n  color: #4c566c;\n\n  background-color: ", ";\n  outline: none;\n  box-sizing: border-box;\n  border-left: ", ";\n  padding-left: -5px;\n\n  pointer-events: ", ";\n  opacity: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: #ffffff;\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"])), function (_a) {
    var isActive = _a.isActive;
    return (isActive ? "#f0f2f8" : "transparent");
}, function (_a) {
    var isActive = _a.isActive;
    return (isActive ? "5px solid #53a8f0" : "none");
}, function (_a) {
    var disabled = _a.disabled;
    return (disabled ? "none" : "unset");
}, function (_a) {
    ...
    var theme = _a.theme;
    return theme.colors.tertiary;
}, rainbowAnimation$2, function (_a) {
    var theme = _a.theme;
    return theme.colors.gradients.bubblegum;
});
...
var templateObject_1$C, templateObject_2$d, templateObject_3$8;
...
var BalanceArea = styled__default['default'].div(templateObject_1$D || (templateObject_1$D = __makeTemplateObject(["\n  width: 170px;\n  margin: auto 10px;\n  display: flex;\n  flex-direction: row;\n"], ["\n  width: 170px;\n  margin: auto 10px;\n  display: flex;\n  flex-direction: row;\n"])));
var Balance = styled__default['default'].div(templateObject_2$e || (templateObject_2$e = __makeTemplateObject(["\n  font: normal normal 18px/24px sans-serif;\n  color: #4C566C;\n  font-size: 15px;\n  opacity: 1;\n  width: 50%;\n  text-align: right;\n"], ["\n  font: normal normal 18px/24px sans-serif;\n  color: #4C566C;\n  font-size: 15px;\n  opacity: 1;\n  width: 50%;\n  text-align: right;\n"])));
var Cost = styled__default['default'].div(templateObject_3$9 || (templateObject_3$9 = __makeTemplateObject(["\n  margin-left: 10px;\n  font: normal normal 18px/24px sans-serif;\n  color: #4C566C;\n  font-size: 15px;\n  opacity: 0.5;\n  width: 50%;\n  text-align: right;\n"], ["\n  margin-left: 10px;\n  font: normal normal 18px/24px sans-serif;\n  color: #4C566C;\n  font-size: 15px;\n  opacity: 0.5;\n  width: 50%;\n  text-align: right;\n"])));
var BalanceContent = function (_a) {
    var _b = _a.balance, balance = _b === void 0 ? 0 : _b, _c = _a.cost, cost = _c === void 0 ? 0 : _c;
    return (React__default['default'].createElement(BalanceArea, null,
        React__default['default'].createElement(Balance, null, balance),
        React__default['default'].createElement(Cost, null,
            "$",
            cost.toFixed(2))));
};
var templateObject_1$D, templateObject_2$e, templateObject_3$9;

var Container$3 = styled__default['default'].div(templateObject_1$E || (templateObject_1$E = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  // Safari fix\n  flex-shrink: 0;\n"], ["\n  display: flex;\n  flex-direction: column;\n  // Safari fix\n  flex-shrink: 0;\n"])));
var MainContainer = styled__default['default'].div(templateObject_2$f || (templateObject_2$f = __makeTemplateObject(["\n  display: flex;\n  flex-direction: row;\n  // Safari fix\n  flex-shrink: 0;\n"], ["\n  display: flex;\n  flex-direction: row;\n  // Safari fix\n  flex-shrink: 0;\n"])));
styled__default['default'](Icon$8)(templateObject_3$a || (templateObject_3$a = __makeTemplateObject(["\n  color: #000000;\n  fill: #000000;\n"], ["\n  color: #000000;\n  fill: #000000;\n"])));
var AccordionContent$1 = styled__default['default'].div(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  max-height: ", ";\n  transition: max-height 0.3s ease-out;\n  overflow: hidden;\n"], ["\n  max-height: ", ";\n  transition: max-height 0.3s ease-out;\n  overflow: hidden;\n"])), function (_a) {
    var isOpen = _a.isOpen, maxHeight = _a.maxHeight;
    return (isOpen ? maxHeight + "px" : 0);
});
var SideBarSubAndSubMenu = function (_a) {
    var label = _a.label, icon = _a.icon, isPushed = _a.isPushed, pushNav = _a.pushNav, _b = _a.initialOpenState, initialOpenState = _b === void 0 ? true : _b, children = _a.children, className = _a.className, _c = _a.showBalance, showBalance = _c === void 0 ? false : _c, balance = _a.balance, cost = _a.cost, _d = _a.coin, coin = _d === void 0 ? undefined : _d;
    var _e = React.useState(initialOpenState), isOpen = _e[0], setIsOpen = _e[1];
    var handleClick = function () {
        if (isPushed) {
            setIsOpen(function (prevState) { return !prevState; });
        }
    ...
    return (React__default['default'].createElement(Container$3, null,
        React__default['default'].createElement(MainContainer, null,
            React__default['default'].createElement(MenuEntrySub, { onClick: handleClick, className: className, showBalance: showBalance },
                icon,
                React__default['default'].createElement(LinkLabelSub, { isPushed: isPushed },
                    label,
                    coin),
                isOpen ? React__default['default'].createElement(Icon$8, { width: "30px" }) : React__default['default'].createElement(Icon$7, { width: "30px" })),
            showBalance && React__default['default'].createElement(BalanceContent, { balance: balance, cost: cost })),
        React__default['default'].createElement(AccordionContent$1, { isOpen: isOpen, isPushed: isPushed, maxHeight: React__default['default'].Children.count(children) * MENU_ENTRY_HEIGHT }, children)));
};
var templateObject_1$E, templateObject_2$f, templateObject_3$a, templateObject_4$2;

var Icons = IconModule;
var Container$4 = styled__default['default'].div(templateObject_1$F || (templateObject_1$F = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  overflow-y: auto;\n  overflow-x: hidden;\n  height: 100%;\n"], ["\n  display: flex;\n  flex-direction: column;\n  overflow-y: auto;\n  overflow-x: hidden;\n  height: 100%;\n"])));
var SideBarBody = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav, isMobile = _a.isMobile, links = _a.links, showBalance = _a.showBalance;
    ...
    return (React__default['default'].createElement(Container$4, null, links.map(function (entry) {
        ...
        if (entry.items) {
            return (React__default['default'].createElement(SideBarMainAndSubMenu, { key: entry.label, isPushed: isPushed, showBalance: showBalance, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: entry.initialOpenState, className: calloutClass }, isPushed &&
                entry.items.map(function (item) {
                    var IconSub = Icons[item.icon];
                    var iconElementSub = React__default['default'].createElement(IconSub, { width: "20px", mr: "8px" });
                    var coinString = "";
                    if (item.coin) {
                        coinString = (item.coin).concat('Icon');
                    }
                    var CoinSub = Icons[coinString];
                    var coinElementSub = React__default['default'].createElement(CoinSub, { width: "20px", ml: "8px" });
                    var itemCalloutClass = item.calloutClass ? item.calloutClass : undefined;
                    if (item.items) {
                        return (React__default['default'].createElement(SideBarSubAndSubMenu, { key: item.label, isPushed: isPushed, showBalance: showBalance, balance: item.balance, cost: item.cost, pushNav: pushNav, icon: iconElementSub, label: item.label, initialOpenState: item.initialOpenState, className: itemCalloutClass, coin: item.coin ? coinElementSub : '' }, item.items.map(function (subItem) {
                            var IconSubSub = Icons[subItem.icon];
                            var iconElementSubSub = React__default['default'].createElement(IconSubSub, { width: "20px", mr: "8px" });
                            var coinStringSub = "";
                            if (subItem.coin) {
                                coinStringSub = (subItem.coin).concat('Icon');
                            }
                            var CoinSubSub = Icons[coinStringSub];
                            var coinElementSubSub = React__default['default'].createElement(CoinSubSub, { width: "20px", ml: "8px" });
                            item.calloutClass ? item.calloutClass : undefined;
                            return (React__default['default'].createElement(MenuEntrySubSub, { key: subItem.href, showBalance: showBalance, secondary: true, isActive: subItem.href === location.pathname, onClick: handleClick, disabled: subItem.disabled },
                                React__default['default'].createElement(MenuLink, { href: subItem.href },
                                    iconElementSubSub,
                                    React__default['default'].createElement(LinkLabelSub, { isPushed: isPushed },
                                        subItem.label,
                                        subItem.coin ? coinElementSubSub : ''),
                                    showBalance && React__default['default'].createElement(BalanceContent, { balance: subItem.balance, cost: subItem.cost }))));
                        })));
                    }
                    return (React__default['default'].createElement(MenuEntrySub, { key: item.href, showBalance: showBalance, secondary: true, isActive: item.href === location.pathname, onClick: handleClick, disabled: item.disabled },
...
var BalanceArea$1 = styled__default['default'].div(templateObject_2$g || (templateObject_2$g = __makeTemplateObject(["\n  width: 220px;\n  margin: 5px 20px;\n  display: flex;\n  flex-direction: row;\n"], ["\n  width: 220px;\n  margin: 5px 20px;\n  display: flex;\n  flex-direction: row;\n"])));
var Title = styled__default['default'].div(templateObject_3$b || (templateObject_3$b = __makeTemplateObject(["\n  font: normal normal bold 20px/24px Swis721 BT;\n  color: #4C566C;\n  font-size: 15px;\n  opacity: 0.5;\n  margin-right: 10px;\n"], ["\n  font: normal normal bold 20px/24px Swis721 BT;\n  color: #4C566C;\n  font-size: 15px;\n  opacity: 0.5;\n  margin-right: 10px;\n"])));
var Cost$1 = styled__default['default'].div(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  margin-right: 10px;\n  font: normal normal bold 20px/24px Swis721 BT;\n  color: #4C566C;\n  font-size: 15px;\n  opacity: 1;\n"], ["\n  margin-right: 10px;\n  font: normal normal bold 20px/24px Swis721 BT;\n  color: #4C566C;\n  font-size: 15px;\n  opacity: 1;\n"])));
var HideArea = styled__default['default'].div(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["\n  width: 170px;\n  text-align: center;\n  vertical-align: middle;\n  font-weight: 500;\n  opacity: 0.5;\n  margin-top: 10px;\n  cursor: pointer;\n"], ["\n  width: 170px;\n  text-align: center;\n  vertical-align: middle;\n  font-weight: 500;\n  opacity: 0.5;\n  margin-top: 10px;\n  cursor: pointer;\n"])));
var ExpandArea = styled__default['default'].div(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  margin: auto;\n  padding-right: 10px;  \n"], ["\n  margin: auto;\n  padding-right: 10px;  \n"])));
var BalanceControl = function (_a) {
    var show = _a.show, _b = _a.totalCost, totalCost = _b === void 0 ? 0 : _b, toggleBalance = _a.toggleBalance;
    var _c = React.useState(false), showTotalCost = _c[0], setShowTotalCost = _c[1];
    var toggleTotalCost = function () {
        setShowTotalCost(!showTotalCost);
    };
    return (React__default['default'].createElement(Container$5, null,
        React__default['default'].createElement(BalanceArea$1, null,
            React__default['default'].createElement(Title, null, "Total Balance"),
            showTotalCost && React__default['default'].createElement(Cost$1, null,
                "$",
                totalCost.toFixed(2)),
            showTotalCost ? React__default['default'].createElement(Icon$1v, { onClick: toggleTotalCost }) : React__default['default'].createElement(Icon$1w, { onClick: toggleTotalCost })),
        React__default['default'].createElement(ExpandArea, null, !show && React__default['default'].createElement(Icon$1x, { onClick: toggleBalance })),
        show && React__default['default'].createElement(HideArea, { onClick: toggleBalance }, "X")));
};
var templateObject_1$G, templateObject_2$g, templateObject_3$b, templateObject_4$3, templateObject_5$1, templateObject_6;
...
var StyledWalletName = styled__default['default'](Text)(templateObject_1$H || (templateObject_1$H = __makeTemplateObject(["\n  margin-left: 20px;\n"], ["\n  margin-left: 20px;\n"])));
var WalletCard = function (_a) {
    ...
    return (React__default['default'].createElement(Button, { fullWidth: true, variant: "tertiary", onClick: function () {
        ...
        React__default['default'].createElement(StyledWalletName, { bold: true, color: "primary", mr: "16px" }, title)));
};
var templateObject_1$H;
...
var CopyToClipboard = function (_a) {
    var toCopy = _a.toCopy, _b = _a.fill, fill = _b === void 0 ? "#000000" : _b, children = _a.children, props = __rest(_a, ["toCopy", "fill", "children"]);
    ...
    return (React__default['default'].createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React__default['default'].createElement(Icon$n, { width: "20px", color: "primary", ml: "4px", fill: fill }),
...
var ContractLinkArea = styled__default['default'](Flex)(templateObject_1$K || (templateObject_1$K = __makeTemplateObject(["\n  height: 46px;\n  padding: 10px;\n  background: #DF642B33 0% 0% no-repeat padding-box;\n  border-radius: 12px;\n  max-width: ", "px;\n  margin: auto 10px;\n"], ["\n  height: 46px;\n  padding: 10px;\n  background: #DF642B33 0% 0% no-repeat padding-box;\n  border-radius: 12px;\n  max-width: ", "px;\n  margin: auto 10px;\n"])), SIDEBAR_WIDTH_FULL_WITHOUT_BALANCE - 20);
var LinkString = styled__default['default'].div(templateObject_2$i || (templateObject_2$i = __makeTemplateObject(["\n  font: normal normal bold 16px/6px Swis721 BT;\n  margin: auto;\n  color: #DF642B;\n  margin-left: 0px;\n"], ["\n  font: normal normal bold 16px/6px Swis721 BT;\n  margin: auto;\n  color: #DF642B;\n  margin-left: 0px;\n"])));
var ContractViewMenu = function (_a) {
    var token = _a.token;
    return (React__default['default'].createElement(ContractLinkArea, null,
        React__default['default'].createElement(LinkString, null, "2LC Contract"),
        React__default['default'].createElement(CopyToClipboard, { toCopy: token, fill: "#000000" },
            React__default['default'].createElement(LinkExternal, { small: true, href: "https://bscscan.com/address/" + token, fill: "#000000" }))));
};
var templateObject_1$K, templateObject_2$i;

var StyledSideBar = styled__default['default'].div(templateObject_1$L || (templateObject_1$L = __makeTemplateObject(["\n  position: fixed;\n  padding-top: ", ";\n  top: 0;\n  left: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background-color: ", ";\n  width: ", ";\n  height: 100vh;\n  transition: padding-top 0.2s, width 0.2s;\n  border-right: ", ";\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n\n  ", " {\n    border-right: 2px solid rgba(133, 133, 133, 0.1);\n    width: ", ";\n    margin-left: 20px;\n  }\n"], ["\n  position: fixed;\n  padding-top: ", ";\n  top: 0;\n  left: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  flex-shrink: 0;\n  background-color: ", ";\n  width: ", ";\n  height: 100vh;\n  transition: padding-top 0.2s, width 0.2s;\n  border-right: ", ";\n  z-index: 11;\n  overflow: ", ";\n  transform: translate3d(0, 0, 0);\n\n  ", " {\n    border-right: 2px solid rgba(133, 133, 133, 0.1);\n    width: ", ";\n    margin-left: 20px;\n  }\n"])), function (_a) {
    ...
    var isPushed = _a.isPushed, showBalance = _a.showBalance;
    return (isPushed ? (showBalance ? SIDEBAR_WIDTH_FULL + "px" : SIDEBAR_WIDTH_FULL_WITHOUT_BALANCE + "px") : 0);
}, function (_a) {
    ...
    var isPushed = _a.isPushed, showBalance = _a.showBalance;
    return (isPushed ? (showBalance ? SIDEBAR_WIDTH_FULL + "px" : SIDEBAR_WIDTH_FULL_WITHOUT_BALANCE + "px") : SIDEBAR_WIDTH_REDUCED) + "px";
});
var StyledButton$1 = styled__default['default'](Button)(templateObject_2$j || (templateObject_2$j = __makeTemplateObject(["\n  background: transparent;\n  border-radius: 6px;\n  font: normal normal bold 16px/6px Swis721 BT;\n  color: white;\n  height: 36px;\n  color: #DF642B;\n  border: 1px solid #DF642B;\n  \n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    background-color: transparent;\n  }\n  padding: 10px 2px;\n  width: 115px;\n"], ["\n  background: transparent;\n  border-radius: 6px;\n  font: normal normal bold 16px/6px Swis721 BT;\n  color: white;\n  height: 36px;\n  color: #DF642B;\n  border: 1px solid #DF642B;\n  \n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    background-color: transparent;\n  }\n  padding: 10px 2px;\n  width: 115px;\n"])));
var StyledConnectButton = styled__default['default'](StyledButton$1)(templateObject_3$c || (templateObject_3$c = __makeTemplateObject(["\n  width: ", "px;\n"], ["\n  width: ", "px;\n"])), SIDEBAR_WIDTH_FULL_WITHOUT_BALANCE - 20);
var StyledFlex = styled__default['default'](Flex)(templateObject_4$4 || (templateObject_4$4 = __makeTemplateObject(["\n  margin: 10px;\n  justify-content: space-between;\n  width: ", "px;\n"], ["\n  margin: 10px;\n  justify-content: space-between;\n  width: ", "px;\n"])), SIDEBAR_WIDTH_FULL_WITHOUT_BALANCE - 20);
var AddButton = styled__default['default'](Button)(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  background: transparent;\n  font: normal normal bold 16px/16px Swis721 BT;\n  height: 36px;\n  padding: 10px;\n  color: #DF642B;\n  border: 1px solid #DF642B;\n  border-radius: 6px;\n  width: ", "px;\n  margin: auto 10px;\n  margin-bottom:\n  text-align: center;\n"], ["\n  background: transparent;\n  font: normal normal bold 16px/16px Swis721 BT;\n  height: 36px;\n  padding: 10px;\n  color: #DF642B;\n  border: 1px solid #DF642B;\n  border-radius: 6px;\n  width: ", "px;\n  margin: auto 10px;\n  margin-bottom:\n  text-align: center;\n"])), SIDEBAR_WIDTH_FULL_WITHOUT_BALANCE - 20);
var StyledHowButton = styled__default['default'].a(templateObject_6$1 || (templateObject_6$1 = __makeTemplateObject(["\n  background: transparent;\n  font: normal normal bold 16px/16px Swis721 BT;\n  height: 36px;\n  padding: 10px;\n  color: #DF642B;\n  border: 1px solid #DF642B;\n  border-radius: 6px;\n  width: ", "px;\n  margin: auto 10px;\n  text-align: center;\n  margin-top: 10px;\n"], ["\n  background: transparent;\n  font: normal normal bold 16px/16px Swis721 BT;\n  height: 36px;\n  padding: 10px;\n  color: #DF642B;\n  border: 1px solid #DF642B;\n  border-radius: 6px;\n  width: ", "px;\n  margin: auto 10px;\n  text-align: center;\n  margin-top: 10px;\n"])), SIDEBAR_WIDTH_FULL_WITHOUT_BALANCE - 20);
var SideBar = function (props) {
    var isPushed = props.isPushed, showMenu = props.showMenu, showBalance = props.showBalance, showBalanceContol = props.showBalanceContol, toggleBalance = props.toggleBalance, totalCost = props.totalCost, showContractButton = props.showContractButton, showBuyButton = props.showBuyButton, account = props.account, login = props.login, logout = props.logout, onBuyCryptoWithSimplex = props.onBuyCryptoWithSimplex, token = props.token, isMobile = props.isMobile, onAddToken = props.onAddToken, showHowButton = props.showHowButton;
    var _a = useWalletModal(login, logout, account), onPresentConnectModal = _a.onPresentConnectModal, onPresentAccountModal = _a.onPresentAccountModal;
    var accountEllipsis = account ? account.substring(0, 4) + "..." + account.substring(account.length - 4) : null;
    return (React__default['default'].createElement(StyledSideBar, { isPushed: isPushed, showMenu: showMenu, showBalance: showBalance },
        showContractButton && isMobile && React__default['default'].createElement(ContractViewMenu, { token: token }),
        React__default['default'].createElement(StyledFlex, null,
            showBuyButton && isMobile &&
                React__default['default'].createElement(StyledButton$1, { size: "sm", variant: "tertiary", onClick: function () {
            ...
            isMobile && !account &&
                React__default['default'].createElement(StyledConnectButton, { size: "sm", onClick: function () {
                        onPresentConnectModal();
                    } }, "Connect Wallet")),
        isMobile && account &&
            React__default['default'].createElement(AddButton, { size: "sm", variant: "tertiary", onClick: function () {
                    onAddToken();
                } }, "Add 2LC to MetaMask"),
        isMobile && showHowButton &&
            React__default['default'].createElement(StyledHowButton, { href: "https://metamask.2local.io", target: "_blank" }, "How"),
        showBalanceContol && React__default['default'].createElement(BalanceControl, { show: showBalance, totalCost: totalCost, toggleBalance: toggleBalance }),
        React__default['default'].createElement(SideBarBody, __assign({}, props))));
};
var templateObject_1$L, templateObject_2$j, templateObject_3$c, templateObject_4$4, templateObject_5$2, templateObject_6$1;

var StyledButton$2 = styled__default['default'](Button)(templateObject_1$M || (templateObject_1$M = __makeTemplateObject(["\n  background: transparent;\n  border-radius: 12px;\n  font: normal normal bold 16px/6px Swis721 BT;\n  color: white;\n  height: 46px;\n  margin-right: 20px;\n  color: #DF642B;\n  border: 1px solid #DF642B;\n  \n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    background-color: transparent;\n  }\n"], ["\n  background: transparent;\n  border-radius: 12px;\n  font: normal normal bold 16px/6px Swis721 BT;\n  color: white;\n  height: 46px;\n  margin-right: 20px;\n  color: #DF642B;\n  border: 1px solid #DF642B;\n  \n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    background-color: transparent;\n  }\n"])));
var StyledLink$2 = styled__default['default'].a(templateObject_2$k || (templateObject_2$k = __makeTemplateObject(["\n  background: transparent;\n  border-radius: 12px;\n  font: normal normal bold 16px/6px Swis721 BT;\n  color: white;\n  height: 46px;\n  margin-right: 20px;\n  padding: 14px;\n  color: #DF642B;\n  border: 1px solid #DF642B;\n\n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    background-color: transparent;\n  }\n"], ["\n  background: transparent;\n  border-radius: 12px;\n  font: normal normal bold 16px/6px Swis721 BT;\n  color: white;\n  height: 46px;\n  margin-right: 20px;\n  padding: 14px;\n  color: #DF642B;\n  border: 1px solid #DF642B;\n\n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    background-color: transparent;\n  }\n"])));
var UserBlock = function (_a) {
    var account = _a.account, login = _a.login, logout = _a.logout, onBuyCryptoWithSimplex = _a.onBuyCryptoWithSimplex, showBuyButton = _a.showBuyButton, isMobile = _a.isMobile, showHowButton = _a.showHowButton, onAddToken = _a.onAddToken;
    var _b = useWalletModal(login, logout, account), onPresentConnectModal = _b.onPresentConnectModal, onPresentAccountModal = _b.onPresentAccountModal;
    var accountEllipsis = account ? account.substring(0, 4) + "..." + account.substring(account.length - 4) : null;
    return (React__default['default'].createElement("div", null,
        !isMobile && account &&
            React__default['default'].createElement(StyledButton$2, { size: "sm", variant: "tertiary", onClick: function () {
                    onAddToken();
                } }, "Add 2LC to MetaMask"),
        !isMobile && showHowButton &&
            React__default['default'].createElement(StyledLink$2, { href: "https://metamask.2local.io", target: "_blank" }, "How"),
        ...
        !isMobile && !account &&
            React__default['default'].createElement(StyledButton$2, { size: "sm", onClick: function () {
                    onPresentConnectModal();
                } }, "Connect Wallet"),
        React__default['default'].createElement(StyledLink$2, { href: "https://sec.2local.io/login", target: "_blank" }, "Account")));
};
...
var StyledAvatar = styled__default['default'].div(templateObject_1$N || (templateObject_1$N = __makeTemplateObject(["\n  margin-left: 8px;\n  position: relative;\n\n  img {\n    border-radius: 50%;\n  }\n"], ["\n  margin-left: 8px;\n  position: relative;\n\n  img {\n    border-radius: 50%;\n  }\n"])));
var Pip = styled__default['default'].div(templateObject_2$l || (templateObject_2$l = __makeTemplateObject(["\n  background-color: ", ";\n  border-radius: 50%;\n  pointer-events: none;\n  height: 8px;\n  position: absolute;\n  right: 0;\n  top: 0;\n  width: 8px;\n"], ["\n  background-color: ", ";\n  border-radius: 50%;\n  pointer-events: none;\n  height: 8px;\n  position: absolute;\n  right: 0;\n  top: 0;\n  width: 8px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.failure;
});
...
var StyledNav = styled__default['default'].nav(templateObject_2$m || (templateObject_2$m = __makeTemplateObject(["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"])), function (_a) {
    var showMenu = _a.showMenu;
...
var Inner = styled__default['default'].div(templateObject_4$5 || (templateObject_4$5 = __makeTemplateObject(["\n  flex-grow: 1;\n  margin-top: ", ";\n  transition: margin-top 0.2s;\n  transform: translate3d(0, 0, 0);\n  ", " {\n    margin-left: ", ";\n  }\n  width: 100%;\n"], ["\n  flex-grow: 1;\n  margin-top: ", ";\n  transition: margin-top 0.2s;\n  transform: translate3d(0, 0, 0);\n  ", " {\n    margin-left: ", ";\n  }\n  width: 100%;\n"])), function (_a) {
    ...
    var isPushed = _a.isPushed, showBalance = _a.showBalance;
    return (isPushed ? (showBalance ? SIDEBAR_WIDTH_FULL : SIDEBAR_WIDTH_FULL_WITHOUT_BALANCE) + 20 : SIDEBAR_WIDTH_REDUCED + 20) + "px";
});
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, onBuyCryptoWithSimplex = _a.onBuyCryptoWithSimplex, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, cakePriceUsd = _a.cakePriceUsd, links = _a.links, priceLink = _a.priceLink, profile = _a.profile, children = _a.children, _c = _a.showBalancePanel, showBalancePanel = _c === void 0 ? false : _c, _d = _a.showBalanceContol, showBalanceContol = _d === void 0 ? false : _d, _e = _a.totalCost, totalCost = _e === void 0 ? 0 : _e, _f = _a.showBuyButton, showBuyButton = _f === void 0 ? false : _f, _g = _a.showContractButton, showContractButton = _g === void 0 ? false : _g, _h = _a.showHowButton, showHowButton = _h === void 0 ? false : _h, onAddToken = _a.onAddToken;
    var isXl = useMatchBreakpoints().isXl;
    var isMobile = isXl === false;
    var _j = React.useState(!isMobile), isPushed = _j[0], setIsPushed = _j[1];
    var _k = React.useState(true), showMenu = _k[0], setShowMenu = _k[1];
    var _l = React.useState(showBalancePanel), showBalance = _l[0], setShowBalance = _l[1];
    ...
    var tokenAddress = '0x11f6ecc9e2658627e0876212f1078b9f84d3196e';
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            React__default['default'].createElement(Logo$1, { isPushed: isPushed, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "https://2local.io/" }),
            showContractButton && !isMobile && React__default['default'].createElement(ContractViewMenu, { token: tokenAddress }),
            React__default['default'].createElement(Flex, null,
                React__default['default'].createElement(UserBlock, { account: account, login: login, logout: logout, onBuyCryptoWithSimplex: onBuyCryptoWithSimplex, showBuyButton: showBuyButton, isMobile: isMobile, showHowButton: showHowButton, onAddToken: onAddToken }),
                profile && React__default['default'].createElement(Avatar, { profile: profile }))),
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(SideBar, { login: login, logout: logout, account: account, onBuyCryptoWithSimplex: onBuyCryptoWithSimplex, isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink, showBalance: showBalance, totalCost: totalCost, toggleBalance: toggleBalance, showBalanceContol: showBalanceContol, showContractButton: showContractButton, showBuyButton: showBuyButton, token: tokenAddress, showHowButton: showHowButton, onAddToken: onAddToken }),
            React__default['default'].createElement(Inner, { isPushed: isPushed, showMenu: showMenu, showBalance: showBalance }, children),
            React__default['default'].createElement(MobileOnlyOverlay, { show: isPushed, onClick: function () { return setIsPushed(false); }, role: "presentation" }))));
};
var templateObject_1$O, templateObject_2$m, templateObject_3$d, templateObject_4$5, templateObject_5$3;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#1d2943", textDisabled: "#8e94a1", textSubtle: "#1d2943", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
